				...
				{revisions.map((rev, idx) => {
					...
					return (
						...
						>
							...
							{rev.issues?.risk && (
								<div className="mt-3">
									<p className="text-sm font-semibold text-gray-800 mb-1">이슈</p>
									<p className="text-gray-700 whitespace-pre-wrap">{rev.issues.risk}</p>
								</div>
							)}
							{rev.suggestions?.safe_alternative && (
								<div className="mt-3">
									<p className="text-sm font-semibold text-gray-800 mb-1">개정안</p>
