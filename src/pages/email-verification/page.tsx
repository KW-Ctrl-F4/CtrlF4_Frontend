...
export default function EmailVerification() {
  ...
  const forcedStatus = (searchParams.get('status') as 'success' | 'failed' | 'expired' | null);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-primary-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">링크가 만료되었습니다</h1>
          <p className="text-gray-600 mb-6">
            인증 링크의 유효시간이 지났습니다.<br />
            새로운 인증 이메일을 요청해주세요.
          </p>
